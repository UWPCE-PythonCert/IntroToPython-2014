...
from fun_with_functions import evaluate_function
...
def test_evaluate_increment():
    ...
    """
    assert evaluate_increment(1.0, 1.25) == 1.0703125

    assert evaluate_increment(1.25, 1.50) == 1.2265625

    assert evaluate_increment(1.50, 1.75) == 1.4140625
